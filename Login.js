        ...
        <div>
          <div>
            <select>
              ...
              <option name="Admin" value={data.name} onChange={changeHandler} onFocus={focusHandler} autoComplete="off" >Admin</option>
              <option name="Admin" value={data.name} onChange={changeHandler} onFocus={focusHandler} autoComplete="off" >User</option>
            </select>
            </div>
            </div>
        </center><br/>
